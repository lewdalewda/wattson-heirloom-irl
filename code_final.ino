...
const char string_3[] PROGMEM = "We're just on different sides of the fence. Cest la vie.";
...
const char string_7[] PROGMEM = "That's a T H I C C fence.";
...
const char string_35[] PROGMEM = "made by @lewda3dprints on instagram";
const char string_36[] PROGMEM = "roblox parkour GOTY";
const char string_37[] PROGMEM = "Burn my BREAAAAAAAAAD";
